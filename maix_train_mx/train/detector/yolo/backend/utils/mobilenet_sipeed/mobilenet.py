...
def MobileNet(input_shape=None,
    ...
    if total_strip_size == 32:
        ...
        raise Exception("total_strip_size not support, only support 16 and 32")
    ...
    if weights == 'imagenet':
        ...
        if alpha == 1.0:
            ...
            alpha_text = '2_5'
        model_name = 'mobilenet_%s_%d_tf_no_top.h5' % (alpha_text, rows)
        weights=os.path.join(os.getcwd(),'train/detector/weights',model_name)
        print("load local weight file:", weights)

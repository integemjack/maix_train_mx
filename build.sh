...
docker run --privileged --pull always --rm -it -p 8888:8888 integem/notebook:maix_train_mx_v4 bash -c "cd maix_train_mx && python train.py -t detector -di ../signal/images -dx ../signal/xml -ep 200 -ap 0.75 -bz 8 train && exit"
